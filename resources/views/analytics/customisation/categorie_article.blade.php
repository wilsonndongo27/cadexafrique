...
<div class="container-fluid">
    ...
    <ol class="breadcrumb mb-4">
        <li class="breadcrumb-item active">Gestion des catégories des articles</li>
    </ol>
    <table id="articles-table" class="table shadow-card">
        <thead style="margin-left:5px">
            <tr style="font-size: 14px;">
                ...
                <a href="#" id="AddCategorie" data-toggle="tooltip" title="Ajouter un article">
                    ...
                    <td>
                        <div class="dropdown">
                            ...
                            <div class="dropdown-content">
                              <a href="Javascript:void()" id="updatecategorie"
                                data-categorieid="{{ $item->id }}"
                                data-name="{{ $item->name }}"
                              >Update</a>
                              <a href="JavaScript:void()" id="deletecategoriemodal"
    ...
    <div id="AddCategorieModal" class="modal fade" role="dialog">
        <div class="modal-dialog modal-lg">
            ...
            <div class="modal-content">
                ...
                <form id="createform" lpformnum="1"  method="post" enctype="multipart/form-data" action="{{ route ('create-categorie') }}">
    ...
    <div id="UpdateCategorieModal" class="modal fade" role="dialog">
        <div class="modal-dialog modal-lg">
            <!-- Modal content-->
            <div class="modal-content">
                <div class="modal-header row">
                ...
                <form id="updateform" lpformnum="1"  method="post" enctype="multipart/form-data" action="{{ route ('update-categorie')}}">
                    <div class="modal-body" style="font-size:14px">
                        @csrf
    ...
    <div id="DeleteCategorie" class="modal fade" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <form id="delete_form" lpformnum="1"  method="post" enctype="multipart/form-data" action="{{ route ('delete-categorie')}}">
                    <div class="modal-body" style="font-size:14px">
                        @csrf

...
class CategorieSolutionsController extends Controller
{
    ...
    public function index()
    {
        if($this->can_access() == true || $this->can_access_admin() == true){
            $allcategorie = DB::table('categoriesolutions')->orderBy('id', 'DESC')->get()->toArray();
            ...
            return view('analytics.solution.categorie_solution', compact('allcategorienew', 'allcategorienew'));
        }else{
    ...
    public function createCategorie(Request $request)
    {
        if($this->can_access() == true || $this->can_access_admin() == true){
            ...
            $categorie = new CategorieSolutions();
    ...
    public function UpdateCategorie(Request $request)
    {
        if($this->can_access() == true || $this->can_access_admin() == true){
            ...
            $currentCategorie = CategorieSolutions::where('id', $categorie_id)->first();
    ...
    public function deleteCategorie(Request $request)
    {
        if($this->can_access() ==  true || $this->can_access_admin() == true){
            ...
            DB::delete('DELETE FROM categoriesolutions WHERE id = ?', [$categorie_id]);
            return response()->json(['message'=>'L\'opération a Réussi!', 'etat'=>'1']);
        }else{
            return view('analytics.401');
        }
